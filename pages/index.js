...
export default function PVTAIRFrat() {
  ...
  const handleStartFresh = useCallback(async () => {
    ...
    try {
      ...
      setCultureSurveys([]); setPilotEngagement([]); setOrgEngagement([]);
      setSafetyRecognitions([]); setOrgRecognitions([]);
  ...
  return (
    ...
    <div style={{ minHeight: "100vh", background: DARK, fontFamily: "'Segoe UI', system-ui, -apple-system, sans-serif" }}>
      ...
      <div className="main-content" style={{ marginLeft: 140 }}>
        ...
        {cv === "flights" && <FlightBoard flights={boardFlights} foreflightFlights={foreflightFlights} schedaeroTrips={schedaeroTrips} onUpdateFlight={onUpdateFlight} initialSelectedFlight={null} adsbEnabled={hasFeature(org, "adsb_tracking")} session={session} fleetAircraft={fleetAircraft} onApproveFlight={async (flightDbId, fratDbId) => {
