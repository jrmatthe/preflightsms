...
function buildTourSeedData(today, userName, fleet) {
  ...
  return {
    ...
    crewRecords: [
      ...
      { id: "_seed_c2", org_id: "_seed", full_name: "A. Johnson", position: "first_officer", status: "active", certificate_type: "Commercial", certificate_number: "COM-789012", certificate_issued: dateStr(-400), ratings: ["Instrument", "Multi-Engine Land"], type_ratings: [ac], medical_class: "Second", medical_issued: dateStr(-335), birth_date: "1992-03-20", basicmed: false, last_ipc: dateStr(-150), last_recurrent: dateStr(-100), last_135_checkride: dateStr(-100), last_line_check: dateStr(-300), notes: "Medical expiring soon" },
      { id: "_seed_c3", org_id: "_seed", full_name: "M. Davis", position: "dispatcher", status: "active", certificate_type: "", certificate_number: "", certificate_issued: "", ratings: [], type_ratings: [], medical_class: "", medical_issued: "", birth_date: "", basicmed: false, last_ipc: "", last_recurrent: "", last_135_checkride: "", last_line_check: "", notes: "Ground operations" },
    ],
    reports: [
