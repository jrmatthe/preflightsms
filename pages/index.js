...
export default function PVTAIRFrat() {
  ...
  const part5Compliance = useMemo(() =>
    computePart5Compliance({ frats: records, flights, reports, hazards, actions, policies, profiles: orgProfiles, trainingRecords: trainingRecs, smsManuals, manualOverrides: auditOverrides }),
    [records, flights, reports, hazards, actions, policies, orgProfiles, trainingRecs, smsManuals, auditOverrides]
  );
