...
const ONBOARDING_STEPS = [
  ...
  { id: "ov-audits", phase: "overview", tab: "audits", target: "nav-audits", placement: "right", title: "Internal Evaluation", adminOnly: true, feature: "internal_evaluation", desc: "Schedule and execute internal audits with templates, findings, and corrective action creation." },
  ...
  { id: "tour-audits", phase: "tour", tab: "audits", title: "Internal Evaluation Program", adminOnly: true, feature: "internal_evaluation", subSteps: [
    { target: "tour-audits-templates", placement: "bottom", title: "Audit Templates", desc: "Create audit templates with sections and questions, or use one of the 8 pre-built templates." },
