...
function NavBar({ currentView, setCurrentView, isAuthed, orgLogo, orgName, userName, onSignOut, org, userRole, notifications, notifReads, onMarkNotifRead, onMarkAllNotifsRead, profile, isOnline, session }) {
  ...
  return (<>
    ...
    <header className="nav-mobile-header" style={{ display: "none", background: BLACK, borderBottom: `1px solid ${BORDER}`, position: "sticky", top: 0, zIndex: 100, padding: "0 16px", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        {isOnline && session && <NotificationCenter notifications={notifications} reads={notifReads} onMarkRead={onMarkNotifRead} onMarkAllRead={onMarkAllNotifsRead} profile={profile} onNavigate={(tab) => { setCurrentView(tab); setMenuOpen(false); }} />}
...
function buildTourSeedData(today, userName, fleet) {
  ...
  return {
    ...
    crewRecords: [
      { id: "_seed_c1", org_id: "_seed", full_name: pilot, position: "captain", status: "active", employee_id: "EMP-001", email: "pic@example.com", phone: "", certificate_type: "ATP", certificate_number: "ATP-123456", certificate_issued: dateStr(-800), ratings: ["Instrument", "Multi-Engine Land"], type_ratings: [ac], medical_class: "First", medical_issued: dateStr(-150), birth_date: "1980-06-15", basicmed: false, base_location: "KSFF", hire_date: dateStr(-1000), last_flight_review: dateStr(-90), last_ipc: dateStr(-60), last_recurrent: dateStr(-45), last_135_checkride: dateStr(-200), notes: "" },
      { id: "_seed_c2", org_id: "_seed", full_name: "A. Johnson", position: "first_officer", status: "active", employee_id: "EMP-002", email: "sic@example.com", phone: "", certificate_type: "Commercial", certificate_number: "COM-789012", certificate_issued: dateStr(-400), ratings: ["Instrument", "Multi-Engine Land"], type_ratings: [ac], medical_class: "Second", medical_issued: dateStr(-335), birth_date: "1992-03-20", basicmed: false, base_location: "KSFF", hire_date: dateStr(-500), last_flight_review: dateStr(-300), last_ipc: dateStr(-150), last_recurrent: dateStr(-100), last_135_checkride: dateStr(-100), notes: "Medical expiring soon" },
      { id: "_seed_c3", org_id: "_seed", full_name: "M. Davis", position: "dispatcher", status: "active", employee_id: "EMP-003", email: "dispatch@example.com", phone: "", certificate_type: "", certificate_number: "", certificate_issued: "", ratings: [], type_ratings: [], medical_class: "", medical_issued: "", birth_date: "", basicmed: false, base_location: "KSFF", hire_date: dateStr(-600), last_flight_review: "", last_ipc: "", last_recurrent: "", last_135_checkride: "", notes: "Ground operations" },
    ],
    reports: [
