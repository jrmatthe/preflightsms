...
export const PILOT_TOUR_FLOWS = {
  ...
  file_report: {
    ...
    steps: [
      ...
      { id: "sr_new", target: "[data-onboarding='sr-new-btn']", title: "New Report", description: "Click + New Report to open the form. We've pre-filled a sample report so you can see how it works.", advanceOn: "click", clickHint: "Click + New Report" },
...
export const MAINTENANCE_TOUR_FLOWS = {
  ...
  file_report: {
    ...
    steps: [
      ...
      { id: "sr_new", target: "[data-onboarding='sr-new-btn']", title: "New Report", description: "Click + New Report to submit a report. We've pre-filled a sample so you can see how it works.", advanceOn: "click", clickHint: "Click + New Report" },
