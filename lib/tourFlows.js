...
export const PILOT_TOUR_FLOWS = {
  ...
  file_report: {
    ...
    tab: "reports",
    steps: [
      { id: "sr_intro", target: null, title: "Safety Reporting", description: "Safety reporting is the backbone of your SMS. Report hazards before they cause incidents, document incidents when they occur, and flag concerns anytime. Reports can be confidential.", advanceOn: "continue" },
      { id: "sr_new", target: "[data-onboarding='sr-new-btn']", title: "New Report", description: "Click + New Report to open the form. Choose a report type (hazard, incident, near miss, or concern), add a title and description, then fill in the details.", advanceOn: "continue" },
      { id: "sr_details", target: "[data-onboarding='sr-details']", title: "Report Details", description: "Add the date, location, severity, flight phase, and category. The more detail you provide, the better your safety team can investigate and prevent recurrence.", advanceOn: "continue" },
      { id: "sr_submit", target: "[data-onboarding='sr-submit-btn']", title: "Submit", description: "Submit your report and it goes to your safety manager for review. You'll be notified of any follow-up actions or investigations.", advanceOn: "dismiss" },
    ],
  },
  check_training: {
    id: "check_training",
...
export const MAINTENANCE_TOUR_FLOWS = {
  ...
  file_report: {
    ...
    tab: "reports",
    steps: [
      { id: "sr_intro", target: null, title: "Safety Reporting", description: "Use safety reports to document hazards, incidents, near misses, and maintenance concerns. Reports go to your safety manager for review and investigation.", advanceOn: "continue" },
      { id: "sr_new", target: "[data-onboarding='sr-new-btn']", title: "New Report", description: "Click + New Report to submit a report. Choose a type, describe what happened, and add any relevant details — date, location, severity, and aircraft involved.", advanceOn: "continue" },
