...
export const PILOT_TOUR_FLOWS = {
  ...
  log_flight: {
    ...
    tab: "flights",
    steps: [
      { id: "ff_intro", target: null, title: "Flight Following", description: "After submitting a FRAT, your flight appears here with its route, aircraft, risk score, and status. We've loaded a demo flight so you can see how it works.", advanceOn: "continue" },
      { id: "ff_active", target: "[data-tour='tour-my-active']", title: "Active Flights", description: "Your in-progress flights show here with departure, destination, tail number, and estimated times. The status shows ENROUTE until you mark the flight as arrived.", advanceOn: "continue" },
      { id: "ff_arrived", target: "[data-tour='tour-my-arrived']", title: "Mark Arrived", description: "When you land, click Mark Arrived on your flight card. You can optionally log parking spot and fuel remaining. If no one marks a flight arrived within 30 minutes of its ETA, all flight followers are notified.", advanceOn: "continue" },
      { id: "ff_all", target: null, title: "All Flights View", description: "If you have flight follower permissions, switch to All Flights to see the live flight map with all active flights plotted between departure and destination — including ADS-B tracking if enabled.", advanceOn: "dismiss" },
    ],
  },
  file_report: {
    id: "file_report",
  ...
  review_policies: {
    ...
    steps: [
      ...
      { id: "pol_stats", target: "[data-tour='tour-policy-stats']", title: "Policy Overview", description: "These cards show the total documents, how many are active, and how many you've acknowledged. Your goal is to acknowledge all active documents.", advanceOn: "continue" },
      { id: "pol_ack", target: "[data-onboarding='policy-ack-stats']", title: "Acknowledgment", description: "The Acknowledged count tracks your progress. Click the Acknowledge button on any document after reading it to confirm you've reviewed it. Your safety team tracks acknowledgment rates for compliance.", advanceOn: "dismiss" },
    ],
  },
};
