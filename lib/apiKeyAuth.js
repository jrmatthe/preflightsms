...
// NOTE: This rate limiter is per-serverless-instance (in-memory). On Vercel, each cold start
// gets its own counter, so the effective limit is (RATE_LIMIT × concurrent_instances).
// For production hardening, consider using Vercel KV or Upstash Redis for shared counters.
