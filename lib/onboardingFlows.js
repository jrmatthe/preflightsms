export const ONBOARDING_FLOWS = {
  ...
  flights: {
    ...
    steps: [
      ...
      { id: "ff_card", target: "[data-onboarding='ff-flight-card']", title: "Flight Card", description: "Each flight shows its route, pilot, status, and progress. Click the card to expand it.", advanceOn: "click" },
      { id: "ff_detail", target: "[data-onboarding='ff-adsb-detail']", title: "Live Tracking", description: "When ADS-B is enabled, live altitude, ground speed, heading, and vertical rate appear here. Click Mark Arrived when the flight lands.", advanceOn: "continue" },
      { id: "ff_arrived", target: "[data-onboarding='ff-arrived-btn']", title: "Mark Arrived", description: "Click this button to mark the flight as arrived at the destination.", advanceOn: "click" },
      { id: "ff_arrival_form", target: "[data-onboarding='ff-arrival-form']", title: "Arrival Details", description: "Optionally enter parking spot and fuel remaining, then click Continue.", advanceOn: "continue" },
      { id: "ff_nudge", target: "[data-onboarding='ff-nudge']", title: "Post-Flight Report", description: "After every arrival, pilots are prompted to file a safety report. This builds a culture of proactive reporting.", advanceOn: "continue" },
...
export const FLOW_ORDER = ["fleet", "frat", "flights"];
